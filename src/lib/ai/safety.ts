...
export function safetyCoachReply(kind: "crisis" | "medical"): string {
  ...
  return "Это уже похоже на вопрос к врачу, а не к приложению. Я не ставлю диагнозы и не назначаю лечение. Если симптомы сильные или пугают — лучше проверить это с специалистом. Здесь можем держать фокус на твоей теме из онбординга и посильных шагах.";
}
